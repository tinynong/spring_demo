...
public class Test2 {
	public static Connection getMySQLConnection() throws Exception {  
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://192.168.1.124:3306/rykjj", "root", "123456");  
        return conn;  
    }  
...
//              System.out.println("字段名称：" + rs.getString("Field") + "\t"+ "字段注释：" + rs.getString("Comment") );  
                System.out.println(rs.getString("Comment") + "\t\t\t\t\t\t"+ rs.getString("Field")  );  
            }   
//          }  
            rs.close();  
        }  
...
//      return map;  
    ...
    public static void main(String[] args) throws Exception {  
        List tables = getAllTableName();  //获取所有表名
